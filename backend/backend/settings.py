"""
Django settings for tow truck backend project.
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='towTruck'),
...
SWAGGER_SETTINGS = {
    'SECURITY_DEFINITIONS': {
        'Token': {
            ...
            'name': 'Authorization',
            'in': 'header',
            'description': 'Token-аутентификация. Формат: Token <ваш_токен>'
        }
    },
...
# Redis settings (для Celery и кэширования)
